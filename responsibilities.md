...
| Task | {{site.data.keyword.IBM_notm}} Responsibilities | Your Responsibilities |
|----------|-----------------------|--------|
| Keep deployed services and resources up to date | N/A | Apply fixes and updates to the compute resources that are created from the deployable architecture. You also must keep your {{site.data.keyword.prodname_imas_short}} instances up to date. For more information, see [Upgrading {{site.data.keyword.prodname_imas_short}}](https://www.ibm.com/docs/en/masv-and-l/continuous-delivery?topic=upgrading-maximo-application-suite-versions){: external}. \n Note that the following resources are not updated through the deployable architecture unless otherwise indicated.   \n * [Red Hat OpenShift clusters](/docs/openshift?topic=openshift-update)  \n * [Kubernetes lusters, worker nodes, and cluster components](/docs/containers?topic=containers-update) \n |
...
|Meet security and compliance objectives| Provide a secure deployable architecture that complies with declared standards. \n For more information about data security, see [How do I know that my data is safe?](/docs/overview?topic=overview-security)  | Secure your workloads and data. Integrate tools into your toolchains that satisfy your security and compliance requirements. \n To learn more about securing your cloud apps, see [Security to safeguard and monitor your cloud apps](/docs/solution-tutorials?topic=solution-tutorials-cloud-e2e-security). |
{: row-headers}
...
|  | {{site.data.keyword.IBM_notm}} Responsibilities | Your Responsibilities |
|----------|-----------------------|--------|
|Meet disaster recovery objectives| {{site.data.keyword.IBM_notm}} follows best practices for disaster recovery. All {{site.data.keyword.IBM}} applications automatically recover and restart after any disaster event. \n For more information about disaster recovery, see the [{{site.data.keyword.IBM_notm}} Disaster Recovery Plan](/docs/overview?topic=overview-zero-downtime#disaster-recovery).  | Customers can help meet disaster recovery objectives by deploying their project in a development or test environment before they deploy to production. The customer does not have to take other actions to prepare for an event of a catastrophic failure in a region. \n For more information, see [Backing up and restoring {{site.data.keyword.prodname_imas_short}}](https://www.ibm.com/docs/en/masv-and-l/continuous-delivery?topic=administering-backing-up-restoring-maximo-application-suite){: external} |
|Meet high availability objectives| {{site.data.keyword.cloud}} is available globally and load balanced from a single URL. It is highly available and continues to run even if your resources are unavailable. \n For more information about high availability, see the [{{site.data.keyword.IBM}} service level objectives](/docs/overview?topic=overview-slo) and the [sample application architecture](/docs/overview?topic=overview-bcdr-app-recovery).  | You can increase the resiliency of the systems to environmental, hardware, or software faults or failure. Techniques and architectural patterns can minimize the impact on the overall system if a planned or unplanned system outage occurs. \n For more information about HA in {{site.data.keyword.prodname_imas_short}}, see [High Availability](https://www.ibm.com/docs/en/masv-and-l/continuous-delivery?topic=planning-high-availability){: external} |
{: row-headers}
